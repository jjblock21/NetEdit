using Dodecaplex.DarkGui.Utilities;
using System.ComponentModel;
using System.Drawing.Drawing2D;

namespace Dodecaplex.DarkGui.Buttons
{
    //I wrote this code before and was too lazy to comment it.
    public class OutlinedButton : ColorSchemeControl
    {
        private Brush brush;
        ...
        protected override void Init(in ColorScheme? colorScheme)
        {
            if (colorScheme == null)
                return;

            //Update all the colors from the color scheme.
            //TODO: Maybe not waste memory by savin this for every button.
            hoverBackColor = colorScheme.ctrl_hover_backColor;
            hoverForeColor = colorScheme.ctrl_hover_textColor;
            clickedBorderColor = colorScheme.ctrl_clicked_borderColor;
            clickedBackColor = colorScheme.ctrl_clicked_backColor;
            borderColor = colorScheme.ctrl_borderColor;
            hoverBorderColor = colorScheme.ctrl_hover_borderColor;
            disabledBackColor = colorScheme.ctrl_disabled_backColor;
            disabledBorderColor = colorScheme.ctrl_disabled_borderColor;
            BackColor = colorScheme.ctrl_backColor;
